...
它是一个 **15822 行纯 bash 脚本**。没有 Node。没有 Python。没有 pip。没有 npm。没有任何你叫得上名字的运行时依赖。
...
- 🐚 **纯 Bash 实现** — 15,822 行代码，439 个函数，无 Node/Python 运行时依赖
...
- ⌨️ **完整 Readline** — 支持 Unicode/CJK 字符、多行编辑、历史搜索、Tab 补全
